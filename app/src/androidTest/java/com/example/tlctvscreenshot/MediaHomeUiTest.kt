...
class MediaHomeUiTest {
    ...
    fun mediaTilesAndGalleryTabsRespond() {
        ...
        composeRule.onNodeWithTag("video_timeline_strip").assertIsDisplayed()
        composeRule.onNodeWithTag("video_trim_start_handle").assertIsDisplayed().performClick()
        assertAnyTextExists("Previewing start", substring = true)
        composeRule.onNodeWithTag("video_trim_end_handle").assertIsDisplayed().performClick()
        assertAnyTextExists("Previewing end", substring = true)
        composeRule.onNodeWithTag("video_trim_seek_slider").assertIsDisplayed()
